<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <title>Editar Produto - Fornecedor</title>
    ...
    <body>
      <%@ include file="includes/header.jsp" %>
        <div class="container-form" role="main">
          ...
          <form id="form-editar-produto" class="card-form">
            ...
            <div class="form-actions">
              ...
              <button type="submit" id="btn-submit" class="btn primary-btn">Salvar Alterações</button>
            </div>
          </form>
        </div>
        <%@ include file="includes/footer.jsp" %>
          <script src="${pageContext.request.contextPath}/js/editar-produto.js"></script>
    </body>

<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <title>Editar Perfil - Fornecedor</title>
    ...
    <body>
      <%@ include file="includes/header.jsp" %>
        <div class="container profile-container" data-fornecedor-id="${fornecedor.id()}">
          ...
          <form id="edit-password-form">
            <section class="profile-section">
              ...
              <div class="form-actions">
                ...
                <a href="<c:url value='/fornecedor/perfil' />" class="button-link-secondary">Cancelar</a>
              </div>
            </section>
          </form>
        </div>
        <%@ include file="includes/footer.jsp" %>
          <script src="${pageContext.request.contextPath}/js/perfil-fornecedor-editar.js"></script>
    </body>
